package dev.yactt.presentation.core.ui.core.util.overscroll
...
abstract class BaseOverscrollEffect(
    ...
    fun getOffsetValue(): Float = animatable.value
                    ...
                    overscrollEffect =
                        object : OverscrollEffect {
                            override fun applyToScroll(
                                ...
                                source: NestedScrollSource,
                                performScroll: (Offset) -> Offset,
                            ): Offset = overscrollEffect.applyToScroll(delta, source, performScroll)

...
import dev.yactt.presentation.core.ui.source.widget.miscellaneous.color.ColorConfigurator
...
fun ThemeColorView(
    ...
    onIntent: (ThemeColorIntent) -> Unit,
) {
    ...
    CompactContainer(
        ...
        headerContent = {
            SimpleHeader(
                title = localisation.theme.color,
                isDividerVisible = scrollableState.canScrollBackward,
                onNavClick = {
                    onIntent(ThemeColorIntent.OnBackClickIntent)
                },
            )
        },
        mainContent = {
            Column(
                ...
                ColorConfigurator(
                    ...
                    onRemoveClick = {
                        onIntent(
                            ThemeColorIntent.RemoveColorIntent(
                                index = it,
                            ),
                        )
                    },
